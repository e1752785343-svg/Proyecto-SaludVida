...
import com.uisrael.saludvida.presentacion.mapeadores.IProductoDtoMapper;
...
public class ProductoControlador {
	...
	public ProductoControlador(IProductoUseCase productoUseCase, IProductoDtoMapper mapper) {
		super();
